    ...
    <div className="space-y-8">
      ...
      {error && (
        <div className="bg-red-900/50 border border-red-700 p-4 rounded-xl flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium text-red-300">Error loading leaderboard</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-700">
            <div className="bg-gradient-to-r from-gray-700 to-gray-800 px-6 py-4 border-b border-gray-600">
              ...
              <p className="text-sm text-gray-400 mt-1">Top performing networks worldwide</p>
            </div>
            <div className="overflow-x-auto">
              ...
              {leaderboard.length === 0 && !isLoading && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-200 mb-2">No Leaderboard Data</h3>
                  <p className="text-gray-400 italic">No ranking data available. Try refreshing the leaderboard.</p>
                </div>
              )}
            </div>
          </div>
